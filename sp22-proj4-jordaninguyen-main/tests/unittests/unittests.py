...
class TestAdd(TestCase):
    ...
    def test_medium_add(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(23, 59, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(23, 59, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    def test_small_abs(self):
        ...
        self.assertTrue(is_correct)
        print_speedup(speed_up)
        dp_mat, nc_mat = rand_dp_nc_matrix(3, 8, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_medium_abs(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(3, 19, seed=0)
        #print(nc_mat)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        # print(dp_mat)
        # print(nc_mat)
        self.assertTrue(is_correct)
        print_speedup(speed_up)
        dp_mat, nc_mat = rand_dp_nc_matrix(45, 34, seed=0)
        #print(nc_mat)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        # print(dp_mat)
        # print(nc_mat)
    ...
    def test_large_abs(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(123, 12356, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
        dp_mat, nc_mat = rand_dp_nc_matrix(2489, 23093, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(30, 30, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(30, 30, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
        # TODO: YOUR CODE HERE
